...
export default {
    ...
    methods: {
        calculateTotalPrice: function() {
            ...
            axios
                .get(
                    this.route("expenses.service.single", this.form.service_id)
                )
                .then(
                    response => (this.form.size = response.data.service.size)
                );
        },
        ...
        updateNetAmout: function() {
            var total =
                this.form.unitprice * this.form.quantity * this.form.size;
        ...
        submit() {
            ...
            this.$inertia.post(
                this.route("expenses.service.store"),
                this.form,
                {
