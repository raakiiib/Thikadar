<template>
    <div>
        <h1 class="mb-8 font-bold text-3xl">
            <inertia-link class="text-indigo-400 hover:text-indigo-600" :href="route('expenses.services')">&#8678; সেবা সমূহ</inertia-link>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            this.$inertia.put(this.route('service.update', this.expense.id), this.form, {
