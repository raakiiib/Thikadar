        ...
        <div class="bg-white rounded shadow overflow-hidden max-w-3xl">
            <form @submit.prevent="submit">
                <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
                    ...
                    <text-input v-model="form.unitprice" :error="errors.unitprice" class="pr-6 pb-8 w-full lg:w-1/2" label="Unit Price" />
    ...
    export default {
        ...
        data() {
            ...
            form: {
                ...
                // net_amount: this.supplier.city,
                net_amount: this.net_amount,
                invoice_number: this.invoice_number,
                created_at: this.supplier.country,
