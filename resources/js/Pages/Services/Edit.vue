...
export default {
    ...
    methods: {
        ...
        submit() {
            this.$inertia.put(
                this.route("services.update", this.service.id),
                this.form,
                {
        ...
        destroy() {
            if (confirm("Are you sure you want to delete this service?")) {
                this.$inertia.delete(
                    this.route("services.destroy", this.service.id)
                );
            }
        },
        restore() {
            if (confirm("Are you sure you want to restore this service?")) {
                this.$inertia.put(
                    this.route("services.restore", this.service.id)
                );
            }
        }
    },
