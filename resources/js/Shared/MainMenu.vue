  ...
  <div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('organizations')">
        ...
        <div :class="isUrl('organizations') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">SUPPLIERS</div>
      </inertia-link>
    </div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('materials')">
        <icon name="office" class="w-4 h-4 mr-2" :class="isUrl('materials') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
